...
- **Авторизованный:** Профиль, Настройки, Выход
...
- [x] **Аутентификация** (регистрация, вход, JWT токены)
- [x] **AuthContext** с управлением состоянием
- [x] **Страница профиля** с редактированием
- [x] **Динамическая навигация** (гость/авторизованный)
- [x] **API endpoints** для пользователей и аутентификации
- [x] **Валидация форм** с визуальными индикаторами
- [x] **Bootstrap UI** с кастомными стилями
- [x] **Развертывание** на Render с CI/CD
